(function(){
	...
	function create(){ // Criar elementos dentro do jogo (val, array)
		...
		/* Pulo com espaço java script puro
		window.addEventListener('keydown',function(e){ //evento disparado para o pulo
			var key = e.keyCode;
			switch(key){
				case 32: pulo = true; break; // cod 32 teclado espaço
			}
		});

		window.addEventListener('keyup',function(e){ //evento larga tecla para o pulo
			var key = e.keyCode;
			switch(key){
				case 32: pulo = false; break; // cod 32 teclado espaço
			}
		}); */

(function(){
	...
	function preload(){ // O que deve ser carregado antes do jogo iniciar
		...
		game.load.image('fala_gaucho','img/fala_gaucho.png');
	...
	function update(){ // Logica do jogo que deve ser verificada a cada loop do jogo(colisão,movimentação)
		...
		if (colidiu == true){
		  ...
		  //	player.animations.play('sentar');
				//fala_gaucho = game.add.sprite(0, 150, 'fala_gaucho');
				//fala_gaucho.scale.setTo(0.5,0.5)

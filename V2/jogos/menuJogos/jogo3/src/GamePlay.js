...
GamePlayManager = {
    ...
    preload: function() {
        ...
        game.load.image('ninja', 'assets/images/ninja.png',420,440);
        game.load.image('ninjaRed', 'assets/images/ninjaRed.png',420,440);
    ...
    create: function() {
        ...
        //LEVEL TEXT
        this.txtCurrentLevel = game.add.bitmapText(70, game.height - 20, 'fontWhite', "NIVEL 1", 25);
        this.txtCurrentLevel.anchor.setTo(0, 1);
        
        //Msg
        this.txtMsgEndLevel = game.add.bitmapText(game.width/2 , game.height/2, 'fontWhite', "FIM DE JOGO", 55);
    ...
    gameOver:function(){
        ...
        this.txtMsgEndLevel.text = "FIM DE JOGO";
    ...
    prepareLevel: function(){
        ...
        this.txtCurrentLevel.text = "NIVEL "+(this.level+1);
       ...
       // var ninja1= newNinja(0,'ninja',537,400,537,304,0.7,0,1500,1500);
    ...
    levelComplete:function(){
        ...
        this.txtMsgEndLevel.visible = true;
        this.txtMsgEndLevel.text = "NIVEL COMPLETO";
